...
const Register = () => {
    ...
    const RegistrationInputs = [
        {
            ...
            labelText: 'Username:',
            note: (
                <Note focus={userFocus} val={user} validVal={validName} id={'uidnote'}>
                    <UserNameNoteContent />
                </Note>
            ),
            inputType: 'text',
        ...
        },
        {
            ...
            val: pwd,
            note: (
                <Note focus={pwdFocus} validVal={validPwd} val={pwd} id={'pwdnote'}>
                    <PwdNoteContent />
                </Note>
            ),
            labelText: 'Password:',
    ...
    return (
        <div className='form-container'>
            {success ? (
                <SuccessSection title={'Success!'} linkText={'Sign In'} link={'login'} />
            ) : (
                <>
                    <section>
                        <ErrorMsgParagraph {...{ errRef }} {...{ errMsg }} />
                        <Title title={'Register'} />
                        <form onSubmit={(e) => handleUserSubmit(e, { user, pwd, setErrMsg, setSuccess })}>
                    ...
                    <FormFooter caption={'Already registered?'} linkText={'Sign In'} link={'login'} />
                </>
            )}
        </div>
    );
