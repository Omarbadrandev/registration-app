...
import { PASSWORD_INPUT_ID, PWD_REGEX, USER_NAME_INPUT_ID, USER_REGEX } from '../../../constants';
...
export const Login = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            const response = await axios.post<LoginResponse>(LOGIN_URL, JSON.stringify({ user, pwd }), RequestsConfig);
            const { data } = response;
    ...
    return (
        <div className='form-container'>
            ...
            <FormFooter caption={'Need an Account?'} linkText={'Sign Up'} link={'register'} />
        </div>
    );
};
